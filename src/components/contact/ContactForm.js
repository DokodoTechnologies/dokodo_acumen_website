                                ...
                                <div className="contact-page__content">
                                    ...
                                    <div className="contact-page__content-single">
                                        <div className="contact-page__content-single-inner">
                                            ...
                                            <div className="content-box">
                                                <h2>Address</h2>
                                                <p>KMC-16, Balaju<br /> Kathmandu, Nepal </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="contact-page__content-single">
                                        <div className="contact-page__content-single-inner">
                                            ...
                                            <div className="content-box">
                                                <h2>Phone</h2>
                                                <p className="number1"><a href="tel:123456789">+977 9841243724</a></p>
                                                <p className="number2"><a href="tel:123456789">01-4364362</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="contact-page__content-single">
                                        <div className="contact-page__content-single-inner">
                                            ...
                                            <div className="content-box">
                                                <h2>Email </h2>
                                                <p className="email1"><a href="mailto: amcs.acumen@gmail.com">amcs.acumen@gmail.com</a></p>
                                                <p className="email2"><a href="mailto: amcs.acumen@gmail.com">amcs.acumen@gmail.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
